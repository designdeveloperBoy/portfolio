...
const Contact = () => {
  return (
    <div id='contact' className='w-full lg:h-screen'>
        ...
        <div className='max-w-[1240px] m-auto px-8 md:px-16 py-28 w-full'>
            ...
            <div className='grid lg:grid-cols-5 gap-8'>
                ...
                <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                    <div className='lg:p-4 h-full'>
                        <div>
                            <img className='rounded-xl hover:scale-105 ease-in duration-300' src='https://inkinccorp.com/wp-content/uploads/2021/04/istockphoto-1216206245-612x612-1.jpg' alt='/' />
                        </div>
                        <div>
                            <h2 className='py-2'>Haider Inam</h2>
